...
│       │   ├── showdetail/ ShowDetailScreen, ShowDetailViewModel (next-episode still image + actual title via TMDB; `NextEpisodeUiState` flow; `EnrichedShowEntry` passed from nav graph)
