...
<!-- stats-start -->
_Last updated: 2026-04-29 — generated by [`scripts/update-readme-stats.sh`](scripts/update-readme-stats.sh)._

| Module | Files | Lines of code | Tests |
|---|---:|---:|---:|
| `app-phone` | 90 | 14 706 | 385 |
| `app-tv` | 76 | 10 936 | 241 |
| `core` | 54 | 7 086 | 389 |
| `backend` | 5 | 1 462 | 86 |
| **Total** | **225** | **34 190** | **1101** |
