...
- **One-tap mark as watched** — press "Mark as watched" on the TV ShowDetailScreen to mark the current next episode as watched on every connected phone account in parallel; the next-episode card slides to the new unwatched episode instantly
...
<!-- stats-start -->
_Last updated: 2026-05-11 — generated by [`scripts/update-readme-stats.sh`](scripts/update-readme-stats.sh)._

| Module | Files | Lines of code | Tests |
|---|---:|---:|---:|
| `app-phone` | 102 | 17 039 | 538 |
| `app-tv` | 90 | 15 011 | 378 |
| `core` | 69 | 9 021 | 554/555 (1 skipped) |
| `backend` | 7 | 2 308 | 150 |
| **Total** | **268** | **43 379** | **1620/1621 (1 skipped)** |
