...
<!-- stats-start -->
_Last updated: 2026-04-30 — generated by [`scripts/update-readme-stats.sh`](scripts/update-readme-stats.sh)._

| Module | Files | Lines of code | Tests |
|---|---:|---:|---:|
| `app-phone` | 94 | 14 827 | 431 |
| `app-tv` | 78 | 12 394 | 299 |
| `core` | 58 | 7 609 | 443 |
| `backend` | 5 | 2 170 | 139 |
| **Total** | **235** | **37 000** | **1312** |
