...
- **Cross-app tracking** via Trakt — manual watched-episode tracking with one-tap mark-as-watched from the TV detail view
...
| `app-tv` | Compose for TV, BLE scanner, WebView recap |
...
<!-- stats-start -->
_Last updated: 2026-08-18 — generated by [`scripts/update-readme-stats.sh`](scripts/update-readme-stats.sh)._

| Module | Files | Lines of code | Tests |
|---|---:|---:|---:|
| `app-phone` | 120 | 19 259 | 602 |
| `app-tv` | 77 | 11 931 | 286 |
| `core` | 57 | 6 276 | 363/364 (1 skipped) |
| `backend` | 7 | 2 308 | 150 |
| **Total** | **261** | **39 774** | **1401/1402 (1 skipped)** |
