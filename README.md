...
<!-- stats-start -->
_Last updated: 2026-04-28 — generated by [`scripts/update-readme-stats.sh`](scripts/update-readme-stats.sh)._

| Module | Files | Lines of code | Tests |
|---|---:|---:|---:|
| `app-phone` | 89 | 14 723 | 385 |
| `app-tv` | 72 | 10 193 | 203 |
| `core` | 53 | 6 487 | 364 |
| `backend` | 5 | 1 462 | 86 |
| **Total** | **219** | **32 865** | **1038** |
